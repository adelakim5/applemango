...
class User_Chat(models.Model):
    ...
    userId = models.ForeignKey(settings.AUTH_USER_MODEL, on_delete=models.CASCADE, null=True, black=True)
...
class Diary(models.Model):
    ...
    word = models.CharField(max_length=100, null=True, blank=True, default="None")
