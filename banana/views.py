...
def word(request, pk):
    ...
    if request.method == 'POST':
        init_jvm(r"C:\Program Files\java\jdk-13.0.2_windows-x64_bin\jdk-13.0.2\bin\server\jvm.dll")
        okt = Okt()
        ...
        for b, c in most:
            tags[b] = c
        wc = WordCloud(background_color='white', font_path=r'C:\Users\User\Downloads\NanumGothicBold.ttf',width=311, height=512, scale=2.0, max_font_size=250)
        ...
        fig.savefig('{}/diaryWord{}.png'.format(BASE_DIR,diary_detail.id))
        diary_detail.word = "diaryWord{}.png".format(diary_detail.id)
        diary_detail.save()
